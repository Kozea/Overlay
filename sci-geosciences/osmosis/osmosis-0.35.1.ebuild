...
src_prepare() {
        ...
        java-pkg_jar-from commons-compress
        java-pkg_jar-from jpf-1.5
}
...
src_install() {
	...
	java-pkg_dolauncher "${PN}" --main "org.openstreetmap.osmosis.core.Osmosis" --classpath   || die "java-pkg_dolauncher failed"
